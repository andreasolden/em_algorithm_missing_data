...
# Simulation 1 ####
  ...
  # Save ####
  saveRDS(monteboot, file = here("simulation_results", "1one_var_base.rds"))
  saveRDS(tot_time, file = here("simulation_results", "1one_var_base_time.rds"))
...
# Simulation 2 ####
  ...
  tot_time = start_time - end_time
  #Save ####
  saveRDS(monteboot, file = here("simulation_results", "2one_var_a_up.rds"))
  saveRDS(tot_time, file = here("simulation_results", "2one_var_a_up_time.rds"))
...
# Simulation 3 ####
  ...
  tot_time = start_time - end_time
  # Save ####
  saveRDS(monteboot, file = here("simulation_results", "3one_var_xsd_up.rds"))
  saveRDS(tot_time, file = here("simulation_results", "3one_var_xsd_up_time.rds"))
...
# Simulation 4 ####
  ...
  tot_time = start_time - end_time
  # Save ####
  saveRDS(monteboot, file = here("simulation_results", "4two_var_base.rds"))
  saveRDS(tot_time, file = here("simulation_results", "4two_var_base_time.rds"))
...
# Simulation 5 ####
  ...
  tot_time = start_time - end_time
  # Save ####
  saveRDS(monteboot, file = here("simulation_results", "5two_var_05corr.rds"))
  saveRDS(tot_time, file = here("simulation_results", "5two_var_05corr_time.rds"))
...
# Simulation 6 ####
  ...
  tot_time = start_time - end_time
  # Save ####
  saveRDS(monteboot, file = here("simulation_results", "6two_var_09corr.rds"))
  saveRDS(tot_time, file = here("simulation_results", "6two_var_09corr_time.rds"))
  ...
  tot_time = start_time - end_time
  # Save ####
  saveRDS(monteboot, file = here("simulation_results", "7two_var_sdx1_up.rds"))
  saveRDS(tot_time, file = here("simulation_results", "7two_var_sdx1_up_time.rds"))
# Simulation 8 ####
  ...
  tot_time = start_time - end_time
  # Save ####
  saveRDS(monteboot, file = here("simulation_results", "8two_var_sdx_up.rds"))
  saveRDS(tot_time, file = here("simulation_results", "8two_var_sdx_up_time.rds"))
  ...
  tot_time = start_time - end_time
  # Save ####
  saveRDS(monteboot, file = here("simulation_results", "9two_var_sdx_and_cor_up.rds"))
  saveRDS(tot_time, file = here("simulation_results", "9two_var_sdx_and_cor_up_time.rds"))
  ...
  # Save ####
  saveRDS(monteboot, file = here("simulation_results", "10two_var_base_new_seed.rds"))
  saveRDS(tot_time, file = here("simulation_results", "10two_var_base_time_new_seed.rds"))
...
# Simulation 11 #### 
  ...
  tot_time = start_time - end_time
  # Save ####
  saveRDS(monteboot, file = here("simulation_results", "11two_var_1000_bootrepl.rds"))
  saveRDS(tot_time, file = here("simulation_results", "11two_var_1000_bootrepl_time.rds"))
