...
monteboot <- 
  foreach(irepl=1:nrepl, .combine=rbind, .packages=("MASS")) %dopar% {
    ...
    if(px==1) {
      thbi = c(rep(mlogitbi$coefficients[1,1],2), mlogitbi$coefficients[2,1])
    } else{
      thbi = c(rep(mlogitbi$coefficients[1,1],2), mlogitbi$coefficients[2,1], mlogitbi$coefficients[3,1])
    }
    
    #Perfect information trinomial logit
    mlogitpi = optim(par=thbi, fn=logl,x=data$x,y=data$y, method = "BFGS", hessian = TRUE)
    mlogitpises = sqrt(diag(solve(mlogitpi$hessian)))
    
    # EM-ALG
    emres=em_algo(them=thbi,y1=data$y1,x=data$x,conv=1e-6,niter=100)
    ...
    for(ibot in 1:bootrepl)
    {
      ...
      modboot = em_algo(them=c(emres$em_a, emres$em_b),y1=xboot[,1], x=xboot[,2:(px+1)], conv=1e-6, niter=100, onlyparam = TRUE)
...
# Save ####
saveRDS(monteboot, file = here("simulation_results", "v2_one_var_base.rds"))
saveRDS(tot_time, file = here("simulation_results", "v2_one_var_base_time.rds"))
...
tot_time = start_time - end_time
#Save ####
saveRDS(monteboot, file = here("simulation_results", "v2_one_var_a_up.rds"))
saveRDS(tot_time, file = here("simulation_results", "v2_one_var_a_up_time.rds"))
...
tot_time = start_time - end_time
# Save ####
saveRDS(monteboot, file = here("simulation_results", "v2_one_var_xsd_up.rds"))
saveRDS(tot_time, file = here("simulation_results", "v2_one_var_xsd_up_time.rds"))
...
tot_time = start_time - end_time
# Save ####
saveRDS(monteboot, file = here("simulation_results", "v2_two_var_base.rds"))
saveRDS(tot_time, file = here("simulation_results", "v2_two_var_base_time.rds"))
...
tot_time = start_time - end_time
# Save ####
saveRDS(monteboot, file = here("simulation_results", "v2_two_var_05corr.rds"))
saveRDS(tot_time, file = here("simulation_results", "v2_two_var_05corr_time.rds"))
...
tot_time = start_time - end_time
# Save ####
saveRDS(monteboot, file = here("simulation_results", "v2_two_var_09corr.rds"))
saveRDS(tot_time, file = here("simulation_results", "v2_two_var_09corr_time.rds"))
...
tot_time = start_time - end_time
# Save ####
saveRDS(monteboot, file = here("simulation_results", "v2_two_var_sdx1_up.rds"))
saveRDS(tot_time, file = here("simulation_results", "v2_two_var_sdx1_up_time.rds"))
# Simulation 8 ####
...
tot_time = start_time - end_time
# Save ####
saveRDS(monteboot, file = here("simulation_results", "v2_two_var_sdx_up.rds"))
saveRDS(tot_time, file = here("simulation_results", "v2_two_var_sdx_up_time.rds"))
...
tot_time = start_time - end_time
# Save ####
saveRDS(monteboot, file = here("simulation_results", "v2_two_var_sdx_and_cor_up.rds"))
saveRDS(tot_time, file = here("simulation_results", "v2_two_var_sdx_and_cor_up_time.rds"))
...
# Save ####
saveRDS(monteboot, file = here("simulation_results", "v2_two_var_base_new_seed.rds"))
saveRDS(tot_time, file = here("simulation_results", "v2_two_var_base_new_seed_time.rds"))
...
tot_time = start_time - end_time
# Save ####
saveRDS(monteboot, file = here("simulation_results", "v2_two_var_1000_bootrepl.rds"))
saveRDS(tot_time, file = here("simulation_results", "v2_two_var_1000_bootrepl_time.rds"))